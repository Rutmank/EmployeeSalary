...
namespace EmployeeSalary
{
    public interface ICompany
    {
        ...
        void RemoveEmployee(Employee employee, DateTime contractEndDate);
        /// <summary>
        ...
        /// <param name="dateAndTime">Date when work was spent. Can be any date in the past and future</param>
        /// <param name="hours">Full hours</param>
        /// <param name="minutes">And minutes</param>
        void AddHours(string employeeId, DateTime dateAndTime, int hours, int minutes);
        /// <summary>
